...
JAR_PATH="${JAR_PATH:-/opt/isr/isr-intelligence-solr-server.jar}"
...
# The Dockerfile copies Temurin 21 JRE under /opt/isr/jre-21. This script is only used
# as the container entrypoint; the default below is container-specific.
JAVA_CREDENTIALS="${JAVA_CREDENTIALS:-/opt/isr/jre-21/bin/java}"
