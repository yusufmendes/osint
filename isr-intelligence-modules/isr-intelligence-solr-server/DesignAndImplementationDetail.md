# Design and implementation detail — isr-intelligence-solr-server
...
Original requirements: `isr-intelligence-modules/isr-intelligence-solr-server.md` (sibling path may vary). Technical decisions taken during implementation:
...
```
isr-intelligence-modules/isr-intelligence-solr-server/
├── pom.xml
├── Dockerfile
├── run-app.sh
├── README.md
...
└── src/main/
    ├── java/com/isr/intelligence/solr/config/SolrCredentialFetcher.java
    └── resources/
...
1. Shaded jar at `/opt/isr/isr-intelligence-solr-server.jar`
...
- Package: `com.isr.intelligence.solr.config`
