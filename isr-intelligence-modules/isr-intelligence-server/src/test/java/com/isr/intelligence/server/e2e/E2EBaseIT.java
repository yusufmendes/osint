...
import com.isr.intelligence.server.outbox.OutboxWorker;
 ...
 *       the sibling {@code isr-intelligence-solr-server} module.</li>
...
public abstract class E2EBaseIT {
    ...
    private static Path resolveSolrConfDir() {
        ...
        Path sibling = Paths.get("..", "isr-intelligence-solr-server", "src", "main", "resources", "conf");
        if (Files.isDirectory(sibling)) {
            return sibling;
        }
        throw new IllegalStateException(
                "Could not locate Solr configset. Tried -Dsolr.conf.dir, target/test-solr-conf, "
                        + "and ../isr-intelligence-solr-server/src/main/resources/conf. "
